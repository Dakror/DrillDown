 ...
 */
@LmlTag(tagName = "seedprompt")
public class SeedPrompt extends Window implements CustomTag {
    Label text;
    TextField input;
    Response<String, Boolean> callback;
    Ui ui;

    public SeedPrompt(Skin skin, String style) {
        super("", skin, style);
        setName("seedprompt");
    }
    ...
    public void postInit() {
        ...
        Util.id("paste").addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                Object paste = Quarry.Q.pi.message(Const.MSG_COPY, null);
                if (paste != null)
                    input.setText(paste.toString());
            }
        });
