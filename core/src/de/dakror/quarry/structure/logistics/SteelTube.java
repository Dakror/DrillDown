 ...
 */
public class SteelTube extends FluidTubeStructure {
    public static FluidTubeSchema classSchema = new FluidTubeSchema(0, StructureType.SteelTube, 10000, 1, 1, "steel_tube", new Items(ItemType.SteelTube, 4), null)
            .sciences(ScienceType.OilProcessing);

    public SteelTube(int x, int y) {
